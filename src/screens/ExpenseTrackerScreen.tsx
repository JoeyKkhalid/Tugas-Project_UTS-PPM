...
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs'; // Tambahkan ini
import { CreateGoalScreen } from './CreateGoalScreen';  // Pastikan path ini sesuai
import { ExpenseTrackerScreen } from './ExpenseTrackerScreen';  // Pastikan path ini sesuai
